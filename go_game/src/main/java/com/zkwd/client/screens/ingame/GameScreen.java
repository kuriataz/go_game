  ...
  private boolean runGame() {
    new Thread() {
      public void run() {
        ...
        //   /**
        //    * App proceeds to the next loop iteration and does nothing until
        //    it receives a signal to move again ("game_go"
        //    * or "game_goagain")
        //    * In that time, a message is only sent to the server if the player
        //    clicks on the board.
        //    * When the player clicks on the board, the app requests to make
        //    the move and waits for the server to
        //    * tell it whether the move is valid or not.
        //    * If the move is valid, the server moves on to ask the other
        //    player.
        //    * Otherwise, the server gives a "game_goagain" signal to the app,
        //    which causes it to move again,
        //    * but without updating the board this time.
        //    *
        //    * Also, all messages received while waiting for "game_go" or
        //    "go_again" are ignored.
        //    *
